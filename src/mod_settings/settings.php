...
<div style="padding-bottom:3px;">
    <fieldset>
        ...
        <div class="field-widget">
            <label><input type="radio" name="style" id="infix" value="Infix" checked="checked"/> Infix </label> <br/>
            <label><input type="radio" name="style" id="polish" value="Polish" /> Polish </label> <br/>
            <label><input type="radio" name="style" id="functional" value="Functional" /> Functional </label> <br/>
        </div>
    </fieldset>
        ...
        <div id="connectives" class="field-widget">
            ...
            <div class="right" id="divGo">
                <div id="btGo" class="left">
                    <button name="back" id="back"><=</button> <br/>
